...
Этот модуль содержит класс UsersPermission, который определяет разрешение для доступа к конечным точкам API
только для аутентифицированных администраторов.
"""
